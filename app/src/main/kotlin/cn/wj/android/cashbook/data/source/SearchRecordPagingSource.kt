 ...
 */
class SearchRecordPagingSource(private val keywords: String, private val local: LocalDataStore) : PagingSource<Int, RecordEntity>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, RecordEntity> {
        return try {
            ...
            val repoItems = if (keywords.isBlank()) {
                ...
                local.getRecordByKeywords("%$keywords%", page, pageSize)
            }
