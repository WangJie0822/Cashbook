...
import org.apache.http4.conn.util.PublicSuffixList;

/**
 * Parses the list from <a href="http://publicsuffix.org/">publicsuffix.org</a>
 * and configures a PublicSuffixFilter.
 *
 * @deprecated (4.4) use {@link org.apache.http4.conn.util.PublicSuffixListParser}.
 *
 * @since 4.0
 */
...
public class PublicSuffixListParser {
    ...
    private final org.apache.http4.conn.util.PublicSuffixListParser parser;

    PublicSuffixListParser(final PublicSuffixFilter filter) {
        this.filter = filter;
        this.parser = new org.apache.http4.conn.util.PublicSuffixListParser();
    }
