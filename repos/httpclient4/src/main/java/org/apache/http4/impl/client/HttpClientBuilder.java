...
import org.apache.http4.client.BackoffManager;
import org.apache.http4.client.ConnectionBackoffStrategy;
import org.apache.http4.client.CookieStore;
import org.apache.http4.client.CredentialsProvider;
import org.apache.http4.client.HttpRequestRetryHandler;
import org.apache.http4.client.RedirectStrategy;
import org.apache.http4.client.ServiceUnavailableRetryStrategy;
import org.apache.http4.client.UserTokenHandler;
import org.apache.http4.client.config.AuthSchemes;
import org.apache.http4.client.config.RequestConfig;
import org.apache.http4.client.entity.InputStreamFactory;
import org.apache.http4.client.protocol.RequestAcceptEncoding;
...
import org.apache.http4.client.protocol.RequestExpectContinue;
import org.apache.http4.client.protocol.ResponseContentEncoding;
...
import org.apache.http4.conn.DnsResolver;
import org.apache.http4.conn.HttpClientConnectionManager;
import org.apache.http4.conn.SchemePortResolver;
import org.apache.http4.conn.routing.HttpRoutePlanner;
import org.apache.http4.conn.socket.ConnectionSocketFactory;
import org.apache.http4.conn.socket.LayeredConnectionSocketFactory;
import org.apache.http4.conn.socket.PlainConnectionSocketFactory;
import org.apache.http4.conn.ssl.DefaultHostnameVerifier;
import org.apache.http4.conn.ssl.SSLConnectionSocketFactory;
import org.apache.http4.conn.ssl.X509HostnameVerifier;
import org.apache.http4.conn.util.PublicSuffixMatcher;
import org.apache.http4.conn.util.PublicSuffixMatcherLoader;
...
import org.apache.http4.impl.auth.BasicSchemeFactory;
import org.apache.http4.impl.auth.DigestSchemeFactory;
import org.apache.http4.impl.auth.KerberosSchemeFactory;
import org.apache.http4.impl.auth.NTLMSchemeFactory;
import org.apache.http4.impl.auth.SPNegoSchemeFactory;
import org.apache.http4.impl.conn.DefaultProxyRoutePlanner;
import org.apache.http4.impl.conn.DefaultRoutePlanner;
import org.apache.http4.impl.conn.DefaultSchemePortResolver;
import org.apache.http4.impl.conn.PoolingHttpClientConnectionManager;
import org.apache.http4.impl.conn.SystemDefaultRoutePlanner;
import org.apache.http4.impl.execchain.BackoffStrategyExec;
import org.apache.http4.impl.execchain.ClientExecChain;
import org.apache.http4.impl.execchain.MainClientExec;
import org.apache.http4.impl.execchain.ProtocolExec;
import org.apache.http4.impl.execchain.RedirectExec;
import org.apache.http4.impl.execchain.RetryExec;
import org.apache.http4.impl.execchain.ServiceUnavailableRetryExec;
import org.apache.http4.protocol.HttpProcessor;
import org.apache.http4.protocol.HttpProcessorBuilder;
import org.apache.http4.protocol.HttpRequestExecutor;
import org.apache.http4.protocol.ImmutableHttpProcessor;
...
import org.apache.http4.ssl.SSLContexts;
