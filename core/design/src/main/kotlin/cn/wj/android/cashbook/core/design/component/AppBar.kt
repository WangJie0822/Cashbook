 ...
 *
 * @param collapsedTitle the title to be displayed in the top app bar. This title will be used in the app
 * bar's expanded and collapsed states, although in its collapsed state it will be composed with a
 * smaller sized [TextStyle]
 * @param modifier the [Modifier] to be applied to this top app bar
 * @param navigationIcon the navigation icon displayed at the start of the top app bar. This should
...
fun FixedLargeTopAppBar(
    ...
    actions: @Composable RowScope.() -> Unit = {},
    windowInsets: WindowInsets = TopAppBarDefaults.windowInsets,
    titleTextStyle: TextStyle = MaterialTheme.typography.fromToken(TopAppBarLargeTokens.HeadlineFont),
    ...
    TwoRowsTopAppBar(
        ...
        smallTitleTextStyle = titleTextStyle,
        titleBottomPadding = LargeTitleBottomPadding,
        smallTitle = pinnedTitle,
        modifier = modifier,
        navigationIcon = navigationIcon,
        actions = actions,
        colors = colors,
