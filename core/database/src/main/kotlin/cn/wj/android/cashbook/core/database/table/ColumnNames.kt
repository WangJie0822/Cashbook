...
/* 周期记账 */
const val TABLE_SCHEDULE = "db_schedule"
const val TABLE_SCHEDULE_ID = "id"
const val TABLE_SCHEDULE_BOOKS_ID = "books_id"
const val TABLE_SCHEDULE_TYPE_ID = "type_id"
const val TABLE_SCHEDULE_ASSET_ID = "asset_id"
const val TABLE_SCHEDULE_AMOUNT = "amount"
const val TABLE_SCHEDULE_CHARGE = "charge"
const val TABLE_SCHEDULE_CONCESSIONS = "concessions"
const val TABLE_SCHEDULE_REMARK = "remark"
const val TABLE_SCHEDULE_TYPE_CATEGORY = "type_category"
const val TABLE_SCHEDULE_FREQUENCY = "frequency"
const val TABLE_SCHEDULE_START_DATE = "start_date"
const val TABLE_SCHEDULE_END_DATE = "end_date"
const val TABLE_SCHEDULE_RECORD_TIME = "record_time"
const val TABLE_SCHEDULE_LAST_EXECUTED_DATE = "last_executed_date"
const val TABLE_SCHEDULE_ENABLED = "enabled"
const val TABLE_SCHEDULE_REIMBURSABLE = "reimbursable"
const val TABLE_SCHEDULE_TAG_IDS = "tag_ids"
